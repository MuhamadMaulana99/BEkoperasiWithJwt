...
// Import model
const pengajuan = require("./koperasi/pengajuanModel.js")(
  sequelize,
  Sequelize.DataTypes
);
const angsuran = require("./koperasi/angsuranModel.js")(
  sequelize,
  Sequelize.DataTypes
);
const permohonan = require("./koperasi/permohonanModel.js")(
  sequelize,
  Sequelize.DataTypes
);
// const masterAnalisa = require('./master/analisaModel.js')(sequelize, Sequelize.DataTypes);
const masterNasabah = require("./master/nasabahModel.js")(
  sequelize,
  Sequelize.DataTypes
);
const loginModel = require("./Auth/loginModels.js")(
  sequelize,
  Sequelize.DataTypes
);
...
const db = {
  sequelize,
  models: { loginModel, angsuran, permohonan, pengajuan, masterNasabah },
};
